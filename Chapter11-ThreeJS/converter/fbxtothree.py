...
def generate_texture_object(texture):
    ...
    #put this in the same folder as the file
    textureUrl = texture.GetFileName()
    textureUrl = textureUrl.split("\\");
    textureUrl = textureUrl[len(textureUrl) - 1]
    print("path", textureUrl)
